...
namespace FitAirlines.WebAPI.Security
{
    ...
    public class BasicAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            try
            {
                ...
                CurrentUser = await _userService.Authenticate(email, password);
            }
            catch
            {
            ...
            claims.Add(new Claim(ClaimTypes.Role, CurrentUser.UserRole.Title));
